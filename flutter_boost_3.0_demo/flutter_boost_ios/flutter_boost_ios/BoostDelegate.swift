...
class BoostDelegate: NSObject, FlutterBoostDelegate {
    ...
    func pushFlutterRoute(_ options: FlutterBoostRouteOptions!) {
        let vc:FBFlutterViewContainer = BaseFlutterViewController()
    ...
    func popRoute(_ options: FlutterBoostRouteOptions!) {
        ...
        if let vc = self.navigationController?.presentedViewController as? BaseFlutterViewController,vc.uniqueIDString() == options.uniqueId{
